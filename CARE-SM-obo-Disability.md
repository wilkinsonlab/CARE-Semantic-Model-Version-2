...
flowchart TD
    ...
    %% rdf:type edges (indices 1,3,5,6,8,9,13,14,17,18,20,21,22,23,27,29) de-emphasized so the structural backbone stands out
    linkStyle 1,3,5,6,8,9,13,14,17,18,20,21,22,23,27,29 stroke:#bbb,stroke-width:2px,stroke-dasharray:4 3
